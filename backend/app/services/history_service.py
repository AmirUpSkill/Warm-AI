...
class HistoryService:
    ...
    async def add_message(self, session_id: str , role:str , content: str , sources: Optional[str] = None) -> Message:
        """
    ...
    async def delete_session(self, session_id: str ) -> bool:
        """
            Delete a session and it's messages . 
        """
        session = await self.get_session(session_id)
        if session:
            ...
            return True 
        return False
    async def update_session_title(self, session_id:str , new_title: str ) -> Optional[Session]:
        """
